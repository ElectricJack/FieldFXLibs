...
import com.fieldfx.math.OBounds2;
...
public class Line2 implements Serializable
{
  ...
  // ------------------------------------------------------------------------------------------------------------ //
  public String       getType   ( )              { return "Line2"; }
  public Serializable clone     ( )              { return new Line2(); }
  ...
  // --------------------------------------------------------- //
  public Vector2 tangent() { return (new Vector2(-B,A)).nrmeq(); }
//--------------------------------------------------------- //
  public Vector2 normal()  { return (new Vector2(A,B)).nrmeq(); }
  ...
  // --------------------------------------------------------- //
  public boolean collinear( Vector2 v ) { return collinear( v.x, v.y ); }
  public boolean collinear( float x, float y ) {
    float f = Math.abs( (float)( A*x + B*y + C ) );
    float eps = 10*(float)Math.sqrt(Math.abs(A+B+C));
    return f <= eps;
  }
