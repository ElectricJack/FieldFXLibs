...
public class OBounds2
{
  ...
  public LineSeg2 clip( LineSeg2 out, Line2 line ) {
    ...
    else if ( resultB != null && resultC != null && contains(resultB) && contains(resultC) ) return out.set(resultB, resultC);
    else if ( resultB != null && resultD != null && contains(resultB) && contains(resultD) ) return out.set(resultB, resultD);
