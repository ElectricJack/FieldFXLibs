...
public class AABounds3 extends AABounds<Vector2> implements Serializable {
  ...
  // ------------------------------------------------------------------------------------------------------------ //
  public String       getType   ( )              { return "AABounds3"; }
  public Serializable clone     ( )              { return new AABounds3(); }
