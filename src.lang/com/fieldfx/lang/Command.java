...
{ 
  ...
  public abstract int      call      ( ScriptState state, Queue<ExpressionElement> params, int callIndex );
  ...
  protected void addVarParam( String varType, boolean expression ) {
    ...
    if( expression ) { 
      data.paramSignature[ data.params ] |= VariableBank.VARTYPE_EXPRESSION_FLAG;
    }
  ...
  protected Vector2   popVector2 ( Queue<ExpressionElement> params )  { ExpressionElement elm = popVar( params ); return elm == null ?  null  : elm.asVector2(); }
  protected Vector3   popVector3 ( Queue<ExpressionElement> params )  { ExpressionElement elm = popVar( params ); return elm == null ?  null  : elm.asVector3(); }
  // ----------------------------------------------------------------- //
